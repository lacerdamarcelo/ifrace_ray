...
#    sbatch run_ifrace_sbatch.sh experiments_output/ifrace_de_${func_num}.out 48 de_config.json DE CEC17 cec17_config/cec17_ifrace_func${func_num}_instances.txt 48 20 0.3 1 10 30 30 300 /home/g/gomesper/ray_results/validation_data/ifrace_de_${func_num}.txt
    bash run_ifrace_sbatch.sh experiments_output/ifrace_hclpso_${func_num}_600.out 48 hclpso_config.json HCLPSO CEC17 cec17_config/cec17_ifrace_func${func_num}_instances.txt 48 20 0.3 1 10 30 30 600 /home/g/gomesper/ray_results/validation_data/ifrace_hclpso_${func_num}_600.txt
